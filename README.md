...
After installation, make sure you download models' [checkpoint and training datasets](https://huggingface.co/UCASzty) from HF and copy all the folders into the directory where the project resides. All the checkpoints you need are in these folders.
